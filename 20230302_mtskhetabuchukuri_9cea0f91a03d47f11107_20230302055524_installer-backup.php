...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230302_mtskhetabuchukuri_9cea0f91a03d47f11107_20230302055524_archive.zip';
        const ARCHIVE_SIZE       = '223323732';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '9cea0f9-02055524';
        const SECONDARY_PACKAGE_HASH = '5ca12fe-02055524';
        const VERSION            = '1.5.0';
